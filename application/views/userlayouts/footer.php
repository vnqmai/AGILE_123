      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-6 col-md-3 mb-4 mb-md-1">
            <h2 style="font-family:Tahoma; color:white">292 Food</h2>
            <p>Với hơn 35 năm trong việc phục vụ nhu cầu ẩm thực cho mọi tầng lớp, chúng tôi luôn luôn mang đến cho khách hàng những cơ hội trải nghiệm khó quên từ các món ăn bổ dưỡng và nổi tiếng tại Việt Nam. Hãy đăng ký để nhận thực đơn mới nhất cùng chúng tôi, tại sao không?</p>
          </div>
        ...
        <div class="col-6 col-md-3 mb-3 mb-md-0">
            ...
            <form action="https://gmail.us20.list-manage.com/subscribe/post?u=27194df1efa9da27b4c14c282&amp;id=e6038ac8b1" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                <div id="mc_embed_signup_scroll">
            <div class="indicates-required"><span class="asterisk">*</span> Bắt buộc</div>
            ...
            <div id="mce-responses" class="clear">
                ...
                <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_27194df1efa9da27b4c14c282_e6038ac8b1" tabindex="-1" value=""></div>
...
<div class="col-6 col-md-2 mb-3 mb-md-0" style="padding-left: 35px; width: 160px;">
    <div class="footer-titles">Giấy phép</div>
        <a>MXH 363/GP-BTTTT</a>
        <a target="_blank" rel="nofollow" href="http://online.gov.vn/HomePage/WebsiteDisplay.aspx?DocId=13113">
            <img src="public/assets/images/gov_seals.jpg" width="160" style="margin-left: -5px;" alt="logo-da-dang-ky-bo-cong-thuong">
        </a>
        ...
        <div class="row text-center">
          <div class="col-12">
            ...
            <p class="block">&copy; <script>document.write(new Date().getFullYear());</script> <strong class="text-white">292 Food</strong> Nhom 3. All Rights Reserved. <br> Designed &amp; Developed by Nhom 3</p>
            </p>
          </div>
        </div>
      </div>    
